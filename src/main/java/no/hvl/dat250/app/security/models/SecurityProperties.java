...
public class SecurityProperties {
  ...
  public CookieProperties getCookieProps() {
    return this.cookieProps;
  }

  public FirebaseProperties getFirebaseProps() {
    return this.firebaseProps;
  }
  ...
  public boolean equals(final Object o) {
    ...
    if (this$cookieProps == null
        ? other$cookieProps != null
        : !this$cookieProps.equals(other$cookieProps)) {
      return false;
    }
    final Object this$firebaseProps = this.getFirebaseProps();
    final Object other$firebaseProps = other.getFirebaseProps();
    if (this$firebaseProps == null
        ? other$firebaseProps != null
    ...
    if (this$allowedPublicApis == null
        ? other$allowedPublicApis != null
  ...
  public String toString() {
    return "SecurityProperties(cookieProps="
        + this.getCookieProps()
        + ", firebaseProps="
