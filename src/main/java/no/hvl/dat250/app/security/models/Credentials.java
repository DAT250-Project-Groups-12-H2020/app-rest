...
public class Credentials {
    ...
    public CredentialType getType() {return this.type;}

    public FirebaseToken getDecodedToken() {return this.decodedToken;}
    ...
    public void setDecodedToken(FirebaseToken decodedToken) {this.decodedToken = decodedToken; }
    ...
    public boolean equals(final Object o) {
        ...
        if (this$decodedToken == null ? other$decodedToken != null : !this$decodedToken.equals(other$decodedToken)) {
            return false;
        }
    ...
    protected boolean canEqual(final Object other) {return other instanceof Credentials;}
    ...
    public String toString() {
        return "Credentials(type=" + this.getType() + ", decodedToken=" + this.getDecodedToken() + ", idToken=" +
               this.getIdToken() + ", session=" + this.getSession() + ")";
    }
