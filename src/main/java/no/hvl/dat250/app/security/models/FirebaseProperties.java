...
public class FirebaseProperties {
    ...
    public int getSessionExpiryInDays() {return this.sessionExpiryInDays;}

    public String getDatabaseUrl() {return this.databaseUrl;}

    public boolean isEnableStrictServerSession() {return this.enableStrictServerSession;}

    public boolean isEnableCheckSessionRevoked() {return this.enableCheckSessionRevoked;}

    public boolean isEnableLogoutEverywhere() {return this.enableLogoutEverywhere;}

    public void setSessionExpiryInDays(int sessionExpiryInDays) {this.sessionExpiryInDays = sessionExpiryInDays; }
    ...
    protected boolean canEqual(final Object other) {return other instanceof FirebaseProperties;}
    ...
    public String toString() {
        return "FirebaseProperties(sessionExpiryInDays=" + this.getSessionExpiryInDays() + ", databaseUrl=" +
               this.getDatabaseUrl() + ", enableStrictServerSession=" + this.isEnableStrictServerSession() +
               ", enableCheckSessionRevoked=" + this.isEnableCheckSessionRevoked() + ", enableLogoutEverywhere=" +
